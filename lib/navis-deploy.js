...
module.exports = CoreObject.extend({
  ...
  uploadAssets: function(filesMap) {
    var _this = this;
    filesMap.reduce(function(prevPromise, current) {
      console.log('prev', prevPromise);
      return prevPromise.then(function() {
        console.log('callback starting', current.file);
        current.log();
        return this.uploadAsset(current.path, current.file);
      })
    }, function() {
      return RSVP.resolve();
    });
